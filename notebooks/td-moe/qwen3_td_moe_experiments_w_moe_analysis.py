...
OUTPUT_DIR = REPO_ROOT / "results_qwen3_30b_td_moe_w_moe_analysis"
OUTPUT_JSON = OUTPUT_DIR / "qwen3_30b_td_moe_results.json"
...
RUN_SD_MOE_DIAGNOSTICS = True
SD_MOE_TOP1PCT_FLOOR = 8
SD_MOE_HEAD_BAND = (0.0, 0.01)
SD_MOE_TAIL_BAND = (0.01, 0.10)
SD_MOE_PER_LAYER_DUMP_DIR = None  # None -> defaults to OUTPUT_DIR/sd_moe_diagnostics
SD_MOE_TOPK_FOR_INTERVENTION = None  # None -> read num_experts_per_tok from model config
...
cfg = RunnerConfig(
    ...
    run_sd_moe_diagnostics=RUN_SD_MOE_DIAGNOSTICS,
    sd_moe_top1pct_floor=SD_MOE_TOP1PCT_FLOOR,
    sd_moe_head_band=SD_MOE_HEAD_BAND,
    sd_moe_tail_band=SD_MOE_TAIL_BAND,
    sd_moe_per_layer_dump_dir=SD_MOE_PER_LAYER_DUMP_DIR,
    sd_moe_topk_for_intervention=SD_MOE_TOPK_FOR_INTERVENTION,
