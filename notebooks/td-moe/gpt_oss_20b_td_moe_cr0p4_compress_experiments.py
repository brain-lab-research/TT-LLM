# %% [markdown]
# # GPT-OSS 20B TD-MoE Experiments, CR 0.4, Expert Compression
#
# Full MoE-only experiment entrypoint for OpenAI GPT-OSS 20B.
...
# %%
MODEL_ARCH_KEY = "gpt_oss_20b"
GPT_OSS_MODEL_NAME = os.environ.get("GPT_OSS_MODEL_NAME", "openai/gpt-oss-20b")
...
OUTPUT_DIR = OUTPUT_ROOT / "results_gpt_oss_20b_td_moe_cr0p4_compress"
OUTPUT_JSON = OUTPUT_DIR / "gpt_oss_20b_td_moe_cr0p4_compress_results.json"
...
# %%
n_layers = get_num_layers_from_config(GPT_OSS_MODEL_NAME)
TARGET_SETS = middle_out_expanding_layer_sets(
    n_layers,
    label_prefix="gpt_oss_20b_td_moe_middle_out",
...
TARGET_SETS_BY_MODEL = {GPT_OSS_MODEL_NAME: TARGET_SETS}
