# %% [markdown]
# # GPT-OSS 20B TD-MoE Experiments, CR 0.4
#
...
OUTPUT_DIR = OUTPUT_ROOT / "results_gpt_oss_20b_td_moe_cr0p4"
OUTPUT_JSON = OUTPUT_DIR / "gpt_oss_20b_td_moe_cr0p4_results.json"
